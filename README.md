...
(1) 在进行设备快连前，请首先确保开发板处于待连接状态（即配对板上黄灯闪烁中），否则请长安restore按键对设备进行重置
(2) 请首先下载**开发者版**小米智能家庭App（下载地址 https://raw.githubusercontent.com/MiEcosystem/XmPluginSDK/master/Smarthome.apk ）  
(3) 打开小米智能家庭App，并使用您的开发者账号进行登录  
(4) 打开小米智能家庭App，点击右上角的“加号”，并按照提示连接小米开发板  
(5) 在完成小米开发板的快速连接后，您的设备列表中会出现一个新的设备，您就可以通过手机对开发板做一些简单操作了。
